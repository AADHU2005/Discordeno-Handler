...
export async function updateCommands(bot: BotWithCache, scope?: "Guild" | "Global") {
    ...
    if (globalCommands.length && (scope === "Global" || scope === undefined)) {
        console.log("Updating Global Commands, changes should apply in short...");
        await bot.helpers.upsertGlobalApplicationCommands(globalCommands).catch((e) => console.log(e));
    }
